...
int main() {
	...
	do
	{
		...
		case Parser::MOVE:
			...
			{
			case Parser::LEFT:
				console.writeOutput("Moving Left...\n");
				break;
			case Parser::CENTER:
				console.writeOutput("Moving Center...\n");
				break;
			case Parser::RIGHT:
				console.writeOutput("Moving Right...\n");
				break;
			case Parser::BACK:
				console.writeOutput("Moving Back...\n");
				break;
			case Parser::ERROR2:
